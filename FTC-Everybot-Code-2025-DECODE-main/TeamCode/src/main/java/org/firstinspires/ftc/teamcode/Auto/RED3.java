...
@Autonomous(name = "RED3", group = "Auto")
public class RED3 extends OpMode {
    ...
    private final Pose startPose = new Pose(110.69504643962847, 135.7312693498452, Math.toRadians(90));
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                ...
                break;
            case 1:
                if(waitTimer.getElapsedTimeSeconds() > 20) {
            ...
            case 3:
                ...
                if(isCatapultReady() && waitTimer.getElapsedTimeSeconds() > 0.5) {
                    intake.setPower(INTAKE_IN_POWER);
