...
public class BLUE15 extends OpMode {
    ...
    private final Pose scorePose = new Pose(112.6750092686662, 122.45208942216487, Math.toRadians(28)).mirror();
    private final Pose endPose = new Pose(110.6750092686662,126.45208942216487,Math.toRadians(43)).mirror();
    ...
    private final Pose gateEndPose = new Pose(118, 68, Math.toRadians(0)).mirror(); //19.5, 68, 0
